...
/**
 * Slowly drives forward with gyro correction until the gear spring is sensed
 */
public class DriveUntilGearSpring extends Command {
	...
	static final double driveSpeed = 0.2; // out of maximum velocity, -1 to 1
    ...
    public DriveUntilGearSpring() {
    	this(0);
    	useStartingYaw = true;
    }

    public DriveUntilGearSpring(double heading) {
    	super("DriveUntilGearSpring");
    ...
    protected void execute() {
    	double outputVelocity = driveSpeed*RobotMap.maxVelocity;
